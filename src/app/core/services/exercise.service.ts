...
export class ExerciseService {
  ...
  async getExercisesByWorkoutId(id: number) : Promise<ExerciseData[]> {
    return await firstValueFrom( this.http.get<ExerciseData[]>(environment.apiUrl + '/api/exercise/workout/' + id) ); 
  }
